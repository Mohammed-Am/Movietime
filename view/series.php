...
<body>
    ...
    <main>
        ...
        <div class="container mx-auto ">
            ...
            <h4 class="font-weight-light text-secondary">SERIES</h4>
            ...
            <?php
            $con = conect();
            $sql = "SELECT * FROM movies_tv WHERE MorS= 'serie  '";
            ...
            ?>
                ...
                <form action="" method="post" style="display:grid;
                    ...
                    <div class="card  rounded  row" class="col-md-4" style="width: 13rem; margin-top:38px; background-color:#1A1A1A;">
                        ...
                        <div class="card-body">
                            <input type="text" value="<?= $row['idMovies'] ?>" readonly hidden>
                            ...
                            <a href="?action=serieAdd&id=<?= $row['idMovies'] ?>"><button type="button" style="color-background:#515151;"><i class='bx bxs-bookmark'></i>Watchlist</button></a>
