...
<body>
    ...
    <main>
        ...
        <div class="container mx-auto ">
            ...
            <h4 class="font-weight-light text-secondary">FILMS</h4>
            ...
            <?php
            $con = conect();
            $sql = "SELECT * FROM movies_tv WHERE MorS= 'movie'";
                ...
                <form action="" method="post" style="display:grid;
                    ...
                    <div class="card  rounded  row" class="col-md-4" style="width: 13rem; margin-top:38px; background-color:#1A1A1A;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="?action=filmAdd&id=<?= $row['idMovies'] ?>"><button type="button" style="color-background:#515151;"><i class='bx bxs-bookmark'></i>Watchlist</button></a>
